...
export function AdminSidebar() {
  ...
  const navItems = [
    ...
    { name: "Work Orders", href: "/admin/workorders", icon: ClipboardList },
    { name: "Product Orders", href: "/admin/productorders", icon: CalendarDays },
  ...
  return (
    <aside className="w-[260px] bg-[#F5F7FA] h-screen hidden md:flex flex-col border-r border-[#EBEBEB] fixed left-0 top-0 font-dm-sans z-20">
      <div className="h-[72px] px-6 flex items-center justify-between border-b border-[#EBEBEB] bg-[#F5F7FA] shrink-0">
      ...
      <div className="p-5 border-t border-[#EBEBEB] bg-[#F5F7FA] shrink-0">
